...
\section{Development} 
\input{Development.txt}

\section{Assessment} 
\input{Assessment.txt}

\section{Conclusions} 
\input{Conclusions.txt}

\section{References}
\input{References.txt} 

\section{Appendix i: Circuit diagram} %  Create a section 
...
\clearpage
\section{Appendix iii: Source Code - Remote Control} %  Create a section
...
\vspace{5mm}
\linespread{1}
\lstinputlisting[language=C++]{../Remote_control.c}
\linespread{1.6}
\vspace{5mm}


\section{Appendix iv: Source Code - Motor Control} %  Create a section
This section contains the source code from the microcontroller controlling the two motors.
\vspace{5mm}
\linespread{1}
\lstinputlisting[language=C++]{../Motors.c}
\linespread{1.6}
\vspace{5mm}
