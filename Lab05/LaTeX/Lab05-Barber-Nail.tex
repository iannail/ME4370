...
\pagebreak
\input{datafromADC.txt}
\pagebreak
\begin{figure}[h!]
  \center
  \includegraphics[width=1.1\textwidth]{\Lab AutoCAD.pdf}
...
%\begin{figure}[h!]
%\centering
%    \includegraphics[width=1.0\textwidth]{\Lab Flowchart.jpeg}
...
\vspace{5mm}
\linespread{1}
\lstinputlisting[language=C++]{../Lab04.ino}
\linespread{1.6}
\vspace{5mm}
